                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Social-Media-Website"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Study-Notion"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Chat-Bot"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Password-Generator"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Huffman-coding-algo"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Contact-List"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Calculator"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/FiveDigitCounter"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                          ...
                          <Fade bottom>
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <img src={Pro8} alt={Pro8} />
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Ping-Pong-Game"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/priyanshu-mandloi/Resume"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
